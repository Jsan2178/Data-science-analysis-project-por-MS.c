...
A brief abstract and report of my Master's degree thesis project in regression Neural Network application to particle physics [See abstract](./Abstract_thesis_jordan_santillan.pdf).
